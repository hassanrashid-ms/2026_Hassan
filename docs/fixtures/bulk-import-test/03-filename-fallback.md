This file has **no frontmatter** and no H1 heading, so the title should fall
back to the filename itself: `03-filename-fallback.md`.
...
Plain body text otherwise, nothing fancy.
