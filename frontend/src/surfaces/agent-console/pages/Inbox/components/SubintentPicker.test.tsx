...
function renderPicker(currentSubintentId?: string | null, currentSubintentName?: { intent_name: string; subintent_name: string } | null) {
      ...
      intents: [
        {
          ...
          isSystem: false,
          archivedAt: null,
          subintents: [{ id: 'sub-1', name: 'Refunds', formId: null, archivedAt: null, defaultPriority: null, mergedIntoId: null }],
        },
      ],
    })

    const { container } = renderPicker('sub-1', { intent_name: 'Billing', subintent_name: 'Refunds' })
      ...
      intents: [
        {
          ...
          archivedAt: null,
          subintents: [
            { id: 'sub-1', name: 'Refunds', formId: null, archivedAt: null, defaultPriority: null, mergedIntoId: null },
            { id: 'sub-2', name: 'Invoices', formId: null, archivedAt: null, defaultPriority: null, mergedIntoId: null },
          ],
        },
        {
          id: 'intent-2',
          ...
          isSystem: false,
          archivedAt: null,
          subintents: [{ id: 'sub-3', name: 'Crashes', formId: null, archivedAt: null, defaultPriority: null, mergedIntoId: null }],
        },
      ],
    })
      ...
      intents: [
        {
          ...
          subintents: [
            { id: 'sub-1', name: 'Refunds', formId: null, archivedAt: null, defaultPriority: null, mergedIntoId: null },
            { id: 'sub-2', name: 'Archived Sub', formId: null, archivedAt: '2026-01-01T00:00:00Z', defaultPriority: null, mergedIntoId: null },
          ],
        },
        {
          id: 'intent-2',
          ...
          subintents: [{ id: 'sub-3', name: 'Hidden', formId: null, archivedAt: null, defaultPriority: null, mergedIntoId: null }],
        },
      ],
    })
