...
import { completeFormAndHandoff, emitFormTerminated, type TerminalFormStatus } from '../../domain/forms/index.ts'
...
export type AnswerFormResult =
  | {
      ok: false
      reason: 'not_found' | 'no_form_pending' | 'unknown_field' | 'invalid_value' | 'unsupported_field_type'
    }
