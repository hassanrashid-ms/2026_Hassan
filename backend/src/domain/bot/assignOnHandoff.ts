 ...
 * not an error — the caller leaves the conversation unassigned and tells the
 * player nobody's available right now rather than handing it to someone with
 * no open connection to ever see it.
 *
